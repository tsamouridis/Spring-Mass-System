% simulation of sliding method control of the system for known upper bounf
% of the absolute value of function f
...
xd = @(t)2+sin(2.5*t)+2*cos(1.25*t); % desired trajectory
for i = 1:num_of_initial_conditions
    [t,x] = ode45(@(t, x) odefun_sliding_case2(t, x, system_parameters), time_span, initial_conditions(:, i), options);
    ...
    xlabel('$ x_2 (\frac{m}{sec})$','fontsize', 14, 'interpreter', 'latex');
